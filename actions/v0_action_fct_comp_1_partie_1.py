...
class AppFctComp1Partie1(QDialog):
    ...
    def __init__(self, data: sqlite3.Connection):
        ...
        cat = ["mixte","feminin", "masculin"]
        for c in cat:
            self.ui.comboBox_fct_comp_1.addItem(c)

    # Fonction de mise à jour de l'affichage
    @pyqtSlot()
    def refreshResult(self):
        # DONE 1.1 : fonction à modifier pour remplacer la zone de saisie par une liste de valeurs prédéfinies
